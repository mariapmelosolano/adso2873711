...
@section('content')
    ...
    <main class="bg-[#154869] pt-20 bg-cover w-full min-h-[100dvh] flex flex-col justify-center items-center">
        <div class="bg-[#0006] md:w-10/12 w-full text-white p-10 rounded-lg flex flex-col justify-center items-center">
            ...
            {{-- Form --}}
            <form action="{{ url('users') }}" class="my-4 flex flex-col gap-2" method="post" enctype="multipart/form-data" >
                ...
                <div class="mt-4">
                    ...
                    <input type="text" name="document" placeholder="75678000" class="w-full input bg-[transparent] border-white" value="{{ old('document') }}" />
                </div>
                <div>
                    <label class="mt-4" for="">Full Name:</label>
                    <input type="text" name="fullname" placeholder="Jhon Wick" class="w-full input bg-[transparent] border-white" value="{{ old('fullname') }}"/>
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" name="phone" placeholder="3147895678" class="w-full input bg-[transparent] border-white" value="{{ old('phone') }}"/>
                </div>
                <div>
                    <label class="mt-4" for="">Email:</label>
                    <input type="text" name="email" placeholder="jonhw@gmail.com" class="w-full input bg-[transparent] border-white" value="{{ old('email') }}"/>
                </div>
                <div>
                    <label class="mt-4" for="">Password Confirmation:</label>
                    <input type="password" name="password" placeholder="admin" class="w-full input bg-[transparent] border-white" />  
                </div>
                <div>
                    <label class="mt-4" for="">Password:</label>
                    <input type="password" name="password_confirmation" placeholder="admin" class="w-full input bg-[transparent] border-white"/>  
                </div>
                <div>
