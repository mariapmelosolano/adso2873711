...
@section('content')
    ...
    <main class="bg-[#154869] pt-20 bg-cover w-full min-h-[100dvh] flex flex-col justify-center items-center">
        <div class="bg-[#0006] md:w-10/12 w-full text-white p-10 rounded-lg flex flex-col justify-center items-center">
            ...
            <div class="join mt-4">
                <a href="{{ url('pets/create') }}" class="btn btn-success join-item">
                ...
                <a href="{{ url('pets/pdf') }}" class="btn join-item">
                ...
                <a href="{{ url('pets/excel') }}" class="btn join-item">
                ...
                <form action="{{ url('pets/import') }}" class="btn join-item" method="post" enctype="multipart/form-data">     
                    @csrf
                        ...
                        <tr>
                            ...
                            <div class="flex items-center gap-3">
                                ...
                                <div class="mask mask-squircle h-12 w-12">
                                    <img
                                    src="{{ asset('images/pets/'.$pet->photo) }}"
                                    alt="Photo" />
                                </div>
                                </div>
                                <div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('input', '#qsearch', function(event) {
                ...
                setTimeout(() => {
                    $.post("{{ url('pets/search') }}", {'q': $query, '_token': $token},
                        function (data) {
